                ...
                >
                  ...
                  <div className="col-span-1 flex items-center justify-center">
                    <p className="text-green-400 text-sm">
                      ฿
                      {(item.quantity * item.sku.price).toLocaleString(
                        undefined,
                        {
                          minimumFractionDigits: 2,
                        }
                  ...
                  <div className="col-span-1 flex items-center justify-center">
                    <button
                      className="text-red-500 hover:text-red-700 border border-red-500 px-4 py-2 rounded hover:bg-red-500 transition-colors duration-200 cursor-pointer"
                      onClick={() => {
